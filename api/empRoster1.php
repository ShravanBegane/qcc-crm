                ...
                <div class="col-sm-12 col-md-12">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-12" >
                            ...
                            <div style="padding-left: 100px; ">
                                <form action="<?php echo $site_URL ?>api/frontend_roster.php" method="post" id="mm">
                                    <input type="hidden" name="in_time" class="form-control"  value="<?php if(isset($data[0])){echo $data[0]; }else{echo $in_time4;}?>"  required>
                                    <input type="hidden" name="out_time"  class="form-control" value="<?php if(isset($data[1])){echo $data[1];    }else{ echo $out_time4; }?>" required> 
                                    <?php 
                                        if(isset($ok)){
                                            if(isset($value1))
                                            {$value=array();
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-12">
                            ...
                            <?php } ?>
                            <h5 id="status" style="color:green;"></h5><hr>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
				    	<form action="<?php echo $site_URL ?>api/insertrosterdata.php" method="POST" autocomplete="off" id="myForm3">
				    		<small for="">Employee id :</small>
			                <select type="number" class="form-control"  name="newemployee_id"  required >			     <?php 
