...
class Subservices extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_subservices';
	var $table_index= 'subservicesid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_subservicescf', 'subservicesid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_subservices', 'vtiger_subservicescf');
	...
	var $related_tables = Array( 
					'vtiger_subservicescf' => Array('subservicesid')
					);
	...
	var $tab_name_index = Array(
		...
		'vtiger_subservices'   => 'subservicesid',
	    'vtiger_subservicescf' => 'subservicesid');
	...
	var $list_fields = Array (
		...
		'Subservices No' => Array('subservices', 'subservicesno'),
/*'Subservices No'=> Array('subservices', 'subservicesno'),*/
		'Assigned To' => Array('crmentity','smownerid')
	);
	var $list_fields_name = Array (
		/* Format: Field Label => fieldname */
		'Subservices No' => 'subservicesno',
/*'Subservices No'=> 'subservicesno',*/
		'Assigned To' => 'assigned_user_id'
	);

	// Make the field link to detail view
	var $list_link_field = 'subservicesno';
...
/*'Subservices No'=> 'subservicesno',*/
	...
	var $popup_fields = Array ('subservicesno');

	// For Alphabetical search
	var $def_basicsearch_col = 'subservicesno';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'subservicesno';

	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('subservicesno','assigned_user_id');

	var $default_order_by = 'subservicesno';
	...
	*/
	function vtlib_handler($moduleName, $eventType) {
		global $adb;
 		if($eventType == 'module.postinstall') {
			...
			Subservices::checkWebServiceEntry();
			Subservices::createUserFieldTable($moduleName);
			Subservices::addInTabMenu($moduleName);
	...
	static function checkWebServiceEntry() {
		...
		$sql       =  "SELECT count(id) AS cnt FROM vtiger_ws_entity WHERE name = 'Subservices'";
		...
		if($adb->num_rows($result) > 0)
		{
			...
			if($no == 0)
			{
				...
				$ws_entitySql = "INSERT INTO vtiger_ws_entity ( id, name, handler_path, handler_class, ismodule ) VALUES".
						  " (?, 'Subservices','include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation' , 1)";
