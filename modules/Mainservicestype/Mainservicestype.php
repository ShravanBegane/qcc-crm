...
class Mainservicestype extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_mainservicestype';
	var $table_index= 'mainservicestypeid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_mainservicestypecf', 'mainservicestypeid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_mainservicestype', 'vtiger_mainservicestypecf');
	...
	var $related_tables = Array( 
					'vtiger_mainservicestypecf' => Array('mainservicestypeid')
					);
	...
	var $tab_name_index = Array(
		...
		'vtiger_mainservicestype'   => 'mainservicestypeid',
	    'vtiger_mainservicestypecf' => 'mainservicestypeid');
	...
	var $list_fields = Array (
		...
		'Mainservicestype No' => Array('mainservicestype', 'mainservicestypeno'),
/*'Mainservicestype No'=> Array('mainservicestype', 'mainservicestypeno'),*/
		'Assigned To' => Array('crmentity','smownerid')
	);
	var $list_fields_name = Array (
		/* Format: Field Label => fieldname */
		'Mainservicestype No' => 'mainservicestypeno',
/*'Mainservicestype No'=> 'mainservicestypeno',*/
		'Assigned To' => 'assigned_user_id'
	);

	// Make the field link to detail view
	var $list_link_field = 'mainservicestypeno';
...
/*'Mainservicestype No'=> 'mainservicestypeno',*/
	...
	var $popup_fields = Array ('mainservicestypeno');

	// For Alphabetical search
	var $def_basicsearch_col = 'mainservicestypeno';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'mainservicestypeno';

	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('mainservicestypeno','assigned_user_id');

	var $default_order_by = 'mainservicestypeno';
	...
	*/
	function vtlib_handler($moduleName, $eventType) {
		global $adb;
 		if($eventType == 'module.postinstall') {
			...
			Mainservicestype::checkWebServiceEntry();
			Mainservicestype::createUserFieldTable($moduleName);
			Mainservicestype::addInTabMenu($moduleName);
	...
	static function checkWebServiceEntry() {
		...
		$sql       =  "SELECT count(id) AS cnt FROM vtiger_ws_entity WHERE name = 'Mainservicestype'";
		...
		if($adb->num_rows($result) > 0)
		{
			...
			if($no == 0)
			{
				...
				$ws_entitySql = "INSERT INTO vtiger_ws_entity ( id, name, handler_path, handler_class, ismodule ) VALUES".
						  " (?, 'Mainservicestype','include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation' , 1)";
