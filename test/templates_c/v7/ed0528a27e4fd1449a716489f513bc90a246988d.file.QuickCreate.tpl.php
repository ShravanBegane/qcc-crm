<?php /* Smarty version Smarty-3.1.7, created on 2021-05-14 10:51:31
         compiled from "/home/qccrightchoice/public_html/includes/runtime/../../layouts/v7/modules/Calendar/QuickCreate.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12655405603346cb741640-18289640%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ed0528a27e4fd1449a716489f513bc90a246988d' => 
    array (
      0 => '/home/qccrightchoice/public_html/includes/runtime/../../layouts/v7/modules/Calendar/QuickCreate.tpl',
      1 => 1620989448,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '12655405603346cb741640-18289640',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_603346cb8a601',
  'variables' => 
  array (
    'SCRIPTS' => 0,
    'jsModel' => 0,
...
<?php if ($_valid && !is_callable('content_603346cb8a601')) {function content_603346cb8a601($_smarty_tpl) {?>
<script>
...
;return {field: {get: function (name, property) {if (name && property === undefined) {return fieldInfo[name];}if (name && property) {return fieldInfo[name][property]}},isMandatory: function (name) {if (fieldInfo[name]) {return fieldInfo[name].mandatory;}return false;},getType: function (name) {if (fieldInfo[name]) {return fieldInfo[name].type;}return false;}},};})();$("#QuickCreate").on('submit', function(e) {setTimeout(function(){var inputerror = $('.select2-choice').is(".input-error");if(!inputerror){setTimeout(function(){location.reload();}, 2000);}}, 1000);})</script><?php }?></div>
<script>
