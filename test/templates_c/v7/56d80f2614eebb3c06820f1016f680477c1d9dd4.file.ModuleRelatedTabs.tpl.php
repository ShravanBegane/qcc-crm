<?php /* Smarty version Smarty-3.1.7, created on 2021-03-31 08:20:43
         compiled from "/home/qccrightchoice/public_html/includes/runtime/../../layouts/v7/modules/Vtiger/ModuleRelatedTabs.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13024276186033325329b0e8-19021380%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '56d80f2614eebb3c06820f1016f680477c1d9dd4' => 
    array (
      0 => '/home/qccrightchoice/public_html/includes/runtime/../../layouts/v7/modules/Vtiger/ModuleRelatedTabs.tpl',
      1 => 1617178839,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13024276186033325329b0e8-19021380',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_6033325336bb9',
  'variables' => 
  array (
    'DETAILVIEW_LINKS' => 0,
    'RELATED_LINK' => 0,
...
<?php if ($_valid && !is_callable('content_6033325336bb9')) {function content_6033325336bb9($_smarty_tpl) {?>

<div class='related-tabs row'><div class="col-md-11 col-lg-11"><ul class="nav nav-tabs"><?php  $_smarty_tpl->tpl_vars['RELATED_LINK'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['RELATED_LINK']->_loop = false;
...
</span></span><?php }?>&nbsp;<span class="numberCircle hide">0</span></a></li><?php }} ?></ul></li><?php }?></ul></div><div class="col-md-1 col-lg-1 detailViewButtoncontainer" ><div class="pull-right btn-toolbar"><div class="btn-group" style="float: right;"><?php $_smarty_tpl->tpl_vars['STARRED'] = new Smarty_variable($_smarty_tpl->tpl_vars['RECORD']->value->get('starred'), null, 0);?><?php if ($_smarty_tpl->tpl_vars['MODULE']->value!='Products'&&$_smarty_tpl->tpl_vars['MODULE']->value!='Documents'&&$_smarty_tpl->tpl_vars['MODULE']->value!='Assets'&&$_smarty_tpl->tpl_vars['MODULE']->value!='ServiceContracts'&&$_smarty_tpl->tpl_vars['MODULE']->value!='Services'&&$_smarty_tpl->tpl_vars['MODULE']->value!='PriceBooks'&&$_smarty_tpl->tpl_vars['MODULE']->value!='Vendors'&&$_smarty_tpl->tpl_vars['MODULE']->value!='ProjectTask'&&$_smarty_tpl->tpl_vars['MODULE']->value!='ProjectMilestone'&&$_smarty_tpl->tpl_vars['MODULE']->value!='Teams'&&$_smarty_tpl->tpl_vars['MODULE']->value!='Visitors'){?><?php $_smarty_tpl->smarty->_tag_stack[] = array('php', array()); $_block_repeat=true; echo smarty_php_tag(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
