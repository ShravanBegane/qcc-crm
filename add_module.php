...
$module->name = 'Subservices';//(No space in module name)
$module->save();
...
$field0->name = 'subservices_tks_subservicesnam';
$field0->label = 'SubServices Name';
$field0->table = $module->basetable; 
$field0->column = 'subservices_tks_subservicesnam';
